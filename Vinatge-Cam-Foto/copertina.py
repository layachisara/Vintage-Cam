...
input = cv2.imread("foto/scritta.jpg")
...
dst = cv2.addWeighted(output_cv, 0.7, mask_resized, 0.1, 0)

cv2.imshow('Dirty Gray', dst)
cv2.waitKey(0)
cv2.imwrite("foto-output/copertina-5.jpg",dst)
